 ...
 * @author 50684
 */
public class usuario_panel extends javax.swing.JFrame {

    /**
     * Creates new form usuario_panel
     */
    public usuario_panel() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(usuario_panel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new usuario_panel().setVisible(true);
            }
        });
    }
